...
In the expansion planning was obtained, that reduction of $CO_2$-emissions can be reached both with Green certificates and emission taxes. Also a decrease of emissions is possible without support scheme, but the decrease is slower then. Due to the fact that Plexos only respects support schemes and emissions it suggests a build of new nuclear power plants, not considering the intended nuclear shutdown in Germany.
