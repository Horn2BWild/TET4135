...
Generally the energy production flow during summer is higher than during winter because of changing conditions in hydro and solar systems. The wind conditions are changing too but have a lower influence. Wind speeds are at it's maximum at the  beginning and in the end of the year and reach minimal values in summer. Hydro power plants have exactly the opposite effect. Production is at it's maximum in summer, caused by the high inflows through the melting snow. Hydro reservoirs produce a lot of energy in the end and at the beginning of the year caused by high precipitation.\\
The transmissions between the three countries Norway, Sweden and Germany with normal inflow is shown in figure \ref{fig:MTnodetransmissionnormal}. Here it can be seen that most power flows between May and October. In winter there is very low flow between Norway and Sweden. The most continuous flow exists between Norway and Germany. In this scenario, Norway's hydro reservoirs are at a low level and can not produce enough energy required for its own consumption. On the other hand Sweden has an abondant amount of energy produced by small hydro power and can export to Germany and Norway.
\begin{figure}[htbp]
\begin{center}
...
In the dry case scenario Norway is not able to produce enough energy for its demand due to the dry conditions. Sweden can still produce in excess however not that much as in the normal case. Germany’s production is not dependent on the weather condition. Both Sweden and Germany can export to Norway.
...
In the wet case, Sweden is produces a lot more energy than required and can export to Norway. Norway´s hydro power plant get higher inflow than in the other two cases but can´t produce the required amount of energy.
