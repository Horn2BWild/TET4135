...
\end{figure}
\paragraph{transmission\\}
The power transmission on the powerlines between Norway, Sweden and Germany can be found in figure \ref{fig:MTnodetransmissiondry}.
\begin{figure}[htbp]
\begin{center}
...
\end{figure}
\paragraph{emission\\}
$CO_2$-emissions for the whole year 2014 are shown in figure \ref{fig:MTemissionsdry}. Compared to the average inflow scenario the emissions in Norway are a little bit higher. This is because more power is produced with the gas generation unit.
\begin{figure}[htbp]
\begin{center}
